            ...
            <div className="TosMainFrame">
                ...
                <div className="TosSubFrame">
                    ...
                    <Col className="FaQContentFrame">
                        ...
                        <img className="fit-picture" alt="loading" src={gif1}/>
                        <br></br>
                    </Col>
                    ...
                    <Col className="FaQContentFrame">
                        ...
                        <img className="fit-picture" alt="loading" src={gif2}/>
                        <br></br>
                    </Col>
                    ...
                    <Col className="FaQContentFrame">
                        ...
                        <img className="fit-picture" alt="loading" src={gif3}/>
                        <br></br>
                    </Col>
                    ...
                    <Col className="FaQContentFrame">
                        ...
                        <img className="fit-picture" alt="loading" src={gif4}/>
                        <br></br>
                    </Col>
                    ...
                    <Col className="FaQContentFrame">
                        ...
                        <img className="fit-picture" alt="loading" src={gif5}/>
                        <br></br>
                    </Col>

                    <Col className="FaQContentFrame">
                        <h2>설문베이의 로고 및 배너</h2><br></br>
                            <p><img className="surveyIconImg" alt="loading" src={icon8}/>&nbsp;
                                <img className="surveyIconImg" alt="loading" src={icon7}/>
                            - 설문베이 아이콘 (Black)</p>                        
                            <p><img className="surveyIconImg" alt="loading" src={icon1}/>&nbsp;
                                <img className="surveyIconImg" alt="loading" src={icon2}/>
                            - 설문베이 아이콘 (Green)</p>
                            <p><img className="surveyIconImg" alt="loading" src={icon3}/>&nbsp;
                                <img className="surveyIconImg" alt="loading" src={icon4}/>            
                            - 설문베이 아이콘 (Purple)</p>
                            <p><img className="surveyIconImg" alt="loading" src={icon5}/>- 설문베이 메인 로고</p>
                            <p><img className="surveyIconImg" alt="loading" src={icon6}/>- 설문베이 메인 배너</p>
                    </Col>
                </div>
            </div>
        </div>
